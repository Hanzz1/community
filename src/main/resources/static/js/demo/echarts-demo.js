$(function () {
    ...
    var mapoption = {
        ...
        legend: {
            orient: 'vertical',
            x:'left',
            data:['iphone3','iphone4','iphone5','yunnan']
        },
        dataRange: {
            show: false,
            min: 0,
            max: 2500,
            backgroundColor: '#a1dcbb',
            x: 'left',
            y: 'bottom',
            text:['高','低'],           // 文本，默认为数值文本
            calculable : true,
        ...
        series : [
            ...
            // },
            {
                name: 'yunnan',
                type: 'map',
                showLegendSymbol : false, //不显示小圆点
                hoverable: false, //去掉hover效果
                mapType: '云南',
                itemStyle:{
                    normal:{borderColor:"#edf2ca",borderWidth:2,label:{show:false},areaStyle:{color:'#a1dcbb'}},
                    emphasis:{label:{show:false,}}
                },
                data:[
                    {name: '迪庆藏族自治州',value: 2500},
                    {name: '丽江市',value: 2500},
                    {name: '大理白族自治州',value: 2500},
                    {name: '保山市',value: 2500},
                    {name: '昆明市',value: 2500},
                    {name: '玉溪市',value: 2500},
                    {name: '西双版纳傣族自治州',value: 2500},
