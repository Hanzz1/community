...
import com.han.community.dao.CommentMapper;
import com.han.community.model.Comment;
import com.han.community.util.CommunityConstant;
import com.han.community.util.SensitiveFilter;
...
public class CommentService implements CommunityConstant {
    ...
    public int addComment(Comment comment){
        ...
        if (comment.getEntityType() == ENTITY_TYPE_POST){
            final int i = commentMapper.selectCountByEntity(comment.getEntityType(), comment.getEntityId());
